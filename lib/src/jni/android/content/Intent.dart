...
class Intent extends _$jni.JObject {
  ...
  /// The returned object must be released after use, by calling the [release] method.
  charsequence_.CharSequence getCharSequenceExtra(
    _$jni.JString string,
  ) {
  ...
  /// The returned object must be released after use, by calling the [release] method.
  _$jni.JArray<charsequence_.CharSequence> getCharSequenceArrayExtra(
    _$jni.JString string,
  ) {
    return _getCharSequenceArrayExtra(
            ...
            string.reference.pointer)
        .object(const _$jni.JArrayType(charsequence_.$CharSequence$Type()));
  }
  ...
  Intent putExtra$22(
    _$jni.JString string,
    _$jni.JArray<charsequence_.CharSequence> charSequences,
  ) {
    return _putExtra$22(
            reference.pointer,
