...
abstract base mixin class $Activity_ScreenCaptureCallback {
...
final class _$Activity_ScreenCaptureCallback
    with $Activity_ScreenCaptureCallback {
  _$Activity_ScreenCaptureCallback({
    required void Function() onScreenCaptured,
...
class Activity extends _$jni.JObject {
  ...
  /// The returned object must be released after use, by calling the [release] method.
  charsequence_.CharSequence onCreateDescription() {
  ...
  /// The returned object must be released after use, by calling the [release] method.
  charsequence_.CharSequence getTitle() {
